...
describe('generateRssFeed', () => {
  beforeEach(() => {
    ...
    utils.extractMetadata.mockImplementation(file => {
      if (file === '/src/blog/article1.html') {
        return {
          ...
          guid: 'https://example.com/blog/article1',
        }
        ...
        return {
          ...
          guid: 'https://example.com/blog/article2',
        }
      }
      return null
    })
    ...
    utils.feedOptions.outputPath = 'mock-feed.rss'
  })
